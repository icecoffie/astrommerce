    ...
    <>
      ...
      <div className="overflow-hidden rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
        ...
        <div className="px-4 pb-6 text-center lg:pb-8 xl:pb-11.5">
          ...
          <div className="mt-4">
            <h2 className="mb-1.5 mt-4 text-2xl font-semibold text-black dark:text-white flex items-center justify-center gap-1">
              KALA SAMUDERA
            </h2>
            <h3 className="mb-1.5 mt-4 text-2xl font-reguler text-black dark:text-white flex items-center justify-center gap-1">
              @kalasamudera
              <svg
                xmlns="http://www.w3.org/2000/svg"
                ...
                fill="currentColor"
              >
                <path d="M22.5 12l-2.293-2.293.793-3.207-3.207.793L12 1.5 8.207 7.293l-3.207-.793.793 3.207L1.5 12l2.293 2.293-.793 3.207 3.207-.793L12 22.5l3.793-5.793 3.207.793-.793-3.207L22.5 12zM10 16l-4-4 1.41-1.41L10 13.17l6.59-6.59L18 8l-8 8z" />
              </svg>
            </h3>
            <p className="font-medium">Web Designer</p>

            {/* Showcase Certification */}
            <div className="mt-4 text-sm text-body-color dark:text-body-dark">
              <h4 className="font-semibold text-lg mb-2">Sertifikat</h4>
              <p className="text-sm text-body-color dark:text-body-dark">
                - UXCorn UI UX Design Professional Certificate <br />
                - Expert Web Designer Certificate <br />- Frontend Developer
                Certificate
              </p>
            </div>
