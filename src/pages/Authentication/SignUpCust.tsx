...
const SignUpCust = () => {
  ...
  return (
    <>
      <div className="rounded-sm border border-stroke shadow-default overflow-x-hidden dark:border-strokedark dark:bg-boxdark">
        <div className="flex flex-wrap items-center">
          <div className="hidden w-full xl:block xl:w-1/2">
            <div className="py-17.5 px-26 text-center">
              <Link className="mb-5.5 inline-block" to="/">
                <img className="h-16" src={LogoDark} alt="Logo" />
              </Link>
